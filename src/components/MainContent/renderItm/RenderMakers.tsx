...
import { Maker, Question } from 'src/interface';
...
function RenderPortfolio() {
  ...
  const { data, nextPage, refetch, isLoading, isSuccess } = useInfinity<Maker>({
    fetch: (page: number, _?: string) =>
      getPfs(page, keyword?.toLocaleLowerCase()),
    queryKey: keys.makers(keyword?.toLocaleLowerCase()),
  });
